      ...
      <header className="App-header">
            ...
            <section className="shapes" id="my-shapes" name="my-shapes">
              <article className="shape">
                <div className="upper-triangle" id="upper-triangle">
                  <h3 className="triangle-title">WAGA</h3>
                </div>
              </article>
              <article className="shape">
                <div className="lower-triangle" id="lower-triangle">
                  <h3 className="triangle-title">DECYZJA</h3>
                </div>
              </article>
            </section>
        ...
        <section className="user-manual" id="my-user-manual" name="my-user-manual">
          <div className="container">
            ...
            <li>Przejdź do "WAGA", a zobaczysz swoją listę argumentów "ZA" i "PRZECIW".</li>
            <li>Na koniec wciśnij "DECYZJA" i 'Eureka' - masz swoje rozwiązanie. Możesz dopić kawę :-)</li>
            <div>_______________</div>
            <div>Pamiętaj, że argumentów "ZA" i "PPRZECIW" nie musi być tyle samo.</div>
            </ol>
          </div>  
        </section>
        ...
        <article className="shape"></article>
